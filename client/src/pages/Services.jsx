...
const services = [
	...
	},
	{
		...
		image:
			"https://www.ringcentral.com/au/en/blog/wp-content/uploads/2023/10/RingCentral-Webinar-polling.gif",
	},
	{
		...
		image:
			"https://www.hubspot.com/hs-fs/hubfs/dealing%20with%20frustrated%20customers.gif?width=480&height=270&name=dealing%20with%20frustrated%20customers.gif",
	},
	{
	...
	},
	{
		...
		image:
			"https://static.wixstatic.com/media/9278bd_3fbec7effe314af4b12a9f3a349827a8~mv2.gif",
	},
];
const accentIcons = ["🗣️", "🎤", "📞", "🎓", "✨"];
...
const ServicesPage = () => {
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-gray-950 dark:to-black text-gray-900 dark:text-gray-100 py-12 px-4 md:px-20 flex flex-col">
